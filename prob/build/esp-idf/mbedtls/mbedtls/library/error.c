...
/* Begin Auto-Generated Code. */
        ...
        case -(MBEDTLS_ERR_ECP_FEATURE_UNAVAILABLE):
            return (
              "ECP - The requested feature is not available, for example, the requested curve is "
              "not supported");
        ...
        case -(MBEDTLS_ERR_SSL_NO_CLIENT_CERTIFICATE):
            return (
              "SSL - No client certification received from the client, but required by the "
              "authentication mode");
        ...
        case -(MBEDTLS_ERR_SSL_RECEIVED_NEW_SESSION_TICKET):
            return (
              "SSL - * Received NewSessionTicket Post Handshake Message. This error code is "
              "experimental and may be changed or removed without notice");
        ...
        case -(MBEDTLS_ERR_SSL_PK_TYPE_MISMATCH):
            return (
              "SSL - Public key type mismatch (eg, asked for RSA key exchange and presented EC "
              "key)");
        ...
        case -(MBEDTLS_ERR_SSL_CONTINUE_PROCESSING):
            return (
              "SSL - Internal-only message signaling that further message-processing should be "
              "done");
        ...
        case -(MBEDTLS_ERR_X509_FATAL_ERROR):
            return (
              "X509 - A fatal error occurred, eg the chain is too long or the vrfy callback "
              "failed");
